...
- 💻 **Projetos Golang em Scouting:** automação e dashboards para análise de performance de jogadores.  
- 🎯 **Radar Automático CS2:** mapeamento espacial de ações e métricas táticas (eSports).  
- 📈 **Painel de Performance Individual (CS2):** dashboards detalhados com métricas de impacto e consistência.  
